...
<header class="bloque header">
        <div class="centrar nav" id="fondo">
            <div class="logo">
                <h2><i class="fa-solid fa-location-dot"></i></i> GLUP IN</h2>
            </div>

            <div class="search-box">
                <input type="search" id="buscar" placeholder="Buscar destino...">
                <span class="fa fa-search" id="btn"></span>
            </div>
            <div class="enlaces">
                <ul>
                    <li><a href="Secundario/ofertas.php">Precios y ofertas</a></li>
                    <li><a href="Secundario/categorias.php" target="_blank">Categorias</a></li>
                    <li><a href="Secundario/perfil.php?id=<?php echo $id?>"><i class="fa-solid fa-user"></i> Ver Perfil</a></li>
